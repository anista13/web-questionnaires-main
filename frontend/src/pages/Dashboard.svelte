...
<div class="bg-white p-6 rounded shadow w-full max-w-lg">
  ...
  <div class="space-y-3">
    ...
    <div class="flex justify-between items-center">
      ...
      >
        Big Five
        {#if $participant.completed.bigFive}
          ✓
        {/if}
      </button>
      <button
    ...
    <div class="flex justify-between items-center">
      ...
      >
        NASA-TLX
        {#if $participant.completed.nasatlx}
          ✓
        {/if}
      </button>
      <button
